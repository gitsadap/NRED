...
# Import routers
from app.routers import public, appeals, admin, api
# from app.routers import chatbot  # ⏸️ ปิดชั่วคราวเพื่อลดขนาด Vercel deployment
# Redirect routes
...
# app.include_router(chatbot.router)  # ⏸️ ปิดชั่วคราว
